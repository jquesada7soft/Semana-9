...
public class Ejemplo4 extends JFrame {
    ...
    public Ejemplo4() {
        ...
        /*
         * Creamos el objeto de la clase JLabel y le pasamos como parámetro al
         * constructor el texto a mostrar.
         */
        label1 = new JLabel("Hola Mundo.");

        /*
         * Ubicamos al objeto de la clase JLabel llamando al método setBounds, este
         * requiere como parámetros la columna, fila, ancho y alto del JLabel.
         * Finalmente llamamos al método add (metodo heredado de la clase JFrame) que
         * tiene como objetivo añadir el control JLabel al control JFrame
         */
